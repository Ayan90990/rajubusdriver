      ...
      {isTaxi && (
        <div className="taxi-scene" aria-hidden="true">
          <div className="sky-background">
            <div className="deluxe-sun" />
            <div className="deluxe-clouds" aria-hidden="true">
              <span className="deluxe-cloud cloud-one" />
              <span className="deluxe-cloud cloud-two" />
              <span className="deluxe-cloud cloud-three" />
              <span className="deluxe-cloud cloud-four" />
            </div>
            <div className="moon" />
            <div className="stars" />
      ...
      {showSupport && (
        <div className="support-modal-overlay" onClick={() => setShowSupport(false)}>
          <div className="support-modal-card" onClick={e => e.stopPropagation()} role="dialog" aria-modal="true" aria-label="Support and donate">
            ...
            <div className="support-qr-grid single">
